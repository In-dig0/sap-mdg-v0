/* @bruin
name: stg.chk04_taxnum_duplicati_cust
type: pg.sql
depends:
  - stg.clean_check_results
description: >
  CHK04 — Clienti: individua codici fiscali duplicati tra BP diversi.
  Segnala come Warning i record in S_CUST_TAXNUMBERS#ZBP_CodiciFisc
...
SELECT
    'S_CUST_TAXNUMBERS#ZBP_CodiciFisc'          AS source_table,
    'BP'                                         AS category,
    ...
    NOW()                                        AS created_at
FROM raw."S_CUST_TAXNUMBERS#ZBP_CodiciFisc" t
JOIN (
    SELECT
        "TAXTYPE(k/*)",
        "TAXNUM(*)",
