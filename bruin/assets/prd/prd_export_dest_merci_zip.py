...
PRD_TABLE = ("prd", "S_CUST_GEN#ZDM_DatiGenerali")

# Tabelle da raw (filtrate per _source)
RAW_TABLES = [
    "S_CUST_GEN#ZDM-DatiGenerali",        # versione raw — sostituita da prd
...
def build_zip(conn, source_name: str) -> bytes:
    ...
    with zipfile.ZipFile(buf, mode="w", compression=zipfile.ZIP_DEFLATED) as zf:
        ...
        # 2. Tabelle da raw (skip S_CUST_GEN#ZDM-DatiGenerali — già presa da prd)
        raw_prd_equiv = "S_CUST_GEN#ZDM-DatiGenerali"
